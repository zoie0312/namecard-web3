...
const Card = ({ cardData, cardBgColor, colors }: cardProps) => {
    ...
    const getLastName = (str: String | undefined) =>
        (str || "/").split("/").slice(-1)[0];
    ...
    return (
        ...
        >
            <Box
                w={360}
                h={520}
                className={classNames(styles["flip-card-inner"], {
            ...
            >
                <Center
                    ...
                    backgroundColor={cardBgColor || "brand-black"}
                    borderRadius="xl"
                    overflow="hidden"
                    ...
                    <Flex direction="column" w="100%" h="100%">
                        <Flex flex={5} direction="column">
                            <Flex flex={3} direction="column" pr="5">
                                {/* <Text color={convertColor(colors[4]) || "brand"}>Web 3.0</Text> */}
                            ...
                            <VStack
                                ...
                                borderColor={convertColor(colors[4]) || "brand"}
                                spacing="2"
                                flex={4}
                                align="flex-start"
                                mt="5"
                            ...
                            >
                                ...
                                <Link
                                    href={
                                        "https://github.com/" + cardData.github
                                    }
                                    isExternal
                                >
                                    <Flex align="center">
                        ...
                        <Flex flex={1}>
                            {
                                ...
                                <Box
                                    ...
                                    mb={-5}
                                    style={{
                                        WebkitTextStroke: `1px ${convertColor(
                                            colors[3]
                                        )}`,
                                        color: "transparent",
                                        fontWeight: 900,
